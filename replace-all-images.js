...
const filesToUpdate = [
  ...
  'src/components/Hero/HeroOverlays.tsx',
  'src/components/pages/NewsCansat2026Page.tsx',
...
for (const file of filesToUpdate) {
  ...
  // Replace unsplash image links
  content = content.replace(/https:\/\/images\.unsplash\.com\/[a-zA-Z0-9?&=-]+/g, (match) => {
...
console.log('Successfully replaced', replacedCount, 'images across', filesToUpdate.length, 'files');
